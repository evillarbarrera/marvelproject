...
class BattlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create battle" do
    assert_difference('Battle.count') do
      post battles_url, params: { battle: { characters_id: @battle.characters_id, date_fight: @battle.date_fight, people_id: @battle.people_id, result: @battle.result } }
    end
  ...
  test "should update battle" do
    patch battle_url(@battle), params: { battle: { characters_id: @battle.characters_id, date_fight: @battle.date_fight, people_id: @battle.people_id, result: @battle.result } }
